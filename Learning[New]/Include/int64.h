 ...
 *
 * Modified by Xun Luo, xluo@cs.uic.edu to meet MSVC compilation needs for project
 * tsc-i2 (http://tsc-xluo.sourceforge.net).
 */

#ifndef INT64_H_
#define INT64_H_

#define INT64_H_CVSID "$Id: int64.h,v 1.1 2008/06/12 16:12:34 felipe Exp $\n"
...
#else
#if defined(_WIN32) && defined(_MSC_VER) && defined(TSCI2_OS_WIN32)
// for MSVC 6.0
